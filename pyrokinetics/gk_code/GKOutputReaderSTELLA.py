...
from .GKInputSTELLA import GKInputSTELLA
from ..constants import sqrt2
from ..typing import PathLike


class GKOutputReaderSTELLA(GKOutputReader):
    @staticmethod
    ...
    @staticmethod
    def _init_dataset(raw_data: xr.Dataset, gk_input: GKInputSTELLA) -> xr.Dataset:
        """
        Sets coords and attrs of a Pyrokinetics dataset from a stella dataset
        """
        # ky coords
